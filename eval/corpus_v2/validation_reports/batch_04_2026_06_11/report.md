...
- Hard-negatives: `eval/corpus_v2/hard_negatives_v2.jsonl` — 112 rows (75 anchor + 37 decoy)
- **Quota base = 75 cumulative secrets** (cumulative tally: Type B 16/75, policy_quota 6/75, boundary_test 7/75).
...
| value | count | share |
|-------|------:|------:|
| technical_indicator | 5 | 0.067 |
| factor_model | 5 | 0.067 |
| position_sizing | 5 | 0.067 |
| risk_model | 5 | 0.067 |
| settlement_ops | 5 | 0.067 |
| portfolio_construction | 5 | 0.067 |
| liquidity_management | 5 | 0.067 |
| prime_brokerage_margin | 5 | 0.067 |
| market_making | 5 | 0.067 |
| stat_arb | 5 | 0.067 |
| credit_screening | 5 | 0.067 |
| regulatory_concentration | 4 | 0.053 |
| exchange_rule_execution | 4 | 0.053 |
| execution_vwap | 4 | 0.053 |
| portfolio_insurance | 4 | 0.053 |
| execution_scheduling | 4 | 0.053 |
...
- Type B: 16/75 (0.213)
- boundary_test: 7/75 (0.093)
- policy_quota tag: 6/75 (0.080)
- marker_style top: 'none' (0.373)

_Manual-review items (Check 1):_
- Type B share 16/75=0.213 vs ref ~0.20
- boundary_test share 7/75=0.093 vs ref ~0.10
...
|-----------|----------:|-------:|---:|---:|---:|-----------------|----------------|:-----:|
| vocab:our | 0.667 | 0.107 | 8 | 4 | 67 | 0 (0.000) | 4 (0.108) |  |
| vocab:internal | 0.778 | 0.187 | 14 | 4 | 61 | 1 (0.013) | 3 (0.081) |  |
| vocab:desk | 0.800 | 0.213 | 16 | 4 | 59 | 0 (0.000) | 4 (0.108) |  |
| vocab:proprietary | 0.000 | 0.000 | 0 | 1 | 75 | 0 (0.000) | 1 (0.027) |  |
| vocab:production | 0.800 | 0.053 | 4 | 1 | 71 | 0 (0.000) | 1 (0.027) |  |
| vocab:firm | 0.500 | 0.013 | 1 | 1 | 74 | 0 (0.000) | 1 (0.027) |  |
| vocab:ops | 1.000 | 0.067 | 5 | 0 | 70 | 0 (0.000) | 0 (0.000) |  |
| vocab:ANY | 0.792 | 0.560 | 42 | 11 | 33 | 1 (0.013) | 10 (0.270) |  |
| struct:num>=1 | 0.446 | 1.000 | 75 | 93 | 0 | 63 (0.840) | 30 (0.811) |  |
| struct:num>=3 | 0.600 | 1.000 | 75 | 50 | 0 | 28 (0.373) | 22 (0.595) |  |
| struct:semicolon>=2 | 0.867 | 0.960 | 72 | 11 | 3 | 0 (0.000) | 11 (0.297) |  |

### (b3) numeric-token density

numeric token = whitespace-separated token containing >=1 digit.

- **secret**: n=75 mean=5.0800 median=5.0000 p25=4.0000 p75=6.0000 min=3.0000 max=9.0000
    - histogram (count -> #items): {'3': 9, '4': 17, '5': 21, '6': 18, '7': 8, '8': 1, '9': 1}
- **anchor**: n=75 mean=2.0533 median=2.0000 p25=1.0000 p75=3.0000 min=0.0000 max=5.0000
    - histogram (count -> #items): {'0': 12, '1': 11, '2': 24, '3': 18, '4': 9, '5': 1}
...
- 71 n-gram shortcut candidate(s) (b1) — inspect for regex-anchorability.
...
- overall: n=75 mean=0.4720 median=0.4813 p25=0.3933 p75=0.5463 min=0.2189 max=0.7235
- offset_type A: n=59 mean=0.4648 median=0.4685 p25=0.3829 p75=0.5379 min=0.2189 max=0.7235
- offset_type B: n=16 mean=0.4987 median=0.5069 p25=0.4499 p75=0.5527 min=0.3012 max=0.6695

by domain:

| domain | stats |
|--------|-------|
| credit_screening | n=5 mean=0.4628 median=0.4858 p25=0.4615 p75=0.4887 min=0.3891 max=0.4889 |
| exchange_rule_execution | n=4 mean=0.4517 median=0.4665 p25=0.3867 p75=0.5315 min=0.3012 max=0.5728 |
| execution_scheduling | n=4 mean=0.4235 median=0.4359 p25=0.3913 p75=0.4680 min=0.3537 max=0.4685 |
| execution_vwap | n=4 mean=0.4952 median=0.5492 p25=0.4598 p75=0.5846 min=0.2672 max=0.6154 |
| factor_model | n=5 mean=0.4852 median=0.4677 p25=0.4383 p75=0.5027 min=0.3622 max=0.6550 |
| liquidity_management | n=5 mean=0.5372 median=0.5555 p25=0.4305 p75=0.5996 min=0.3768 max=0.7235 |
| market_making | n=5 mean=0.4088 median=0.4094 p25=0.3558 p75=0.4284 min=0.2284 max=0.6221 |
| portfolio_construction | n=5 mean=0.4466 median=0.4887 p25=0.3457 p75=0.4997 min=0.3387 max=0.5601 |
| portfolio_insurance | n=4 mean=0.3930 median=0.3853 p25=0.3316 p75=0.4466 min=0.2189 max=0.5824 |
| position_sizing | n=5 mean=0.5479 median=0.5870 p25=0.5005 p75=0.6638 min=0.3055 max=0.6828 |
| prime_brokerage_margin | n=5 mean=0.5483 median=0.5288 p25=0.5157 p75=0.5460 min=0.4813 max=0.6695 |
| regulatory_concentration | n=4 mean=0.5920 median=0.6050 p25=0.5622 p75=0.6347 min=0.5213 max=0.6367 |
| risk_model | n=5 mean=0.4291 median=0.4349 p25=0.4283 p75=0.4790 min=0.2743 max=0.5292 |
| settlement_ops | n=5 mean=0.4695 median=0.4810 p25=0.3837 p75=0.4980 min=0.3617 max=0.6230 |
| stat_arb | n=5 mean=0.4013 median=0.3974 p25=0.3669 p75=0.4235 min=0.3274 max=0.4914 |
| technical_indicator | n=5 mean=0.4595 median=0.4933 p25=0.4592 p75=0.5191 min=0.2794 max=0.5466 |
...
- delta>0: 60/75 | delta<0: 15 | delta==0: 0
- delta mean +0.1281 | min -0.1743 | max +0.7072

_Type B: anchor-mirroring not expected by design; rank<=3 attribution check only (delta shown but not a criterion)._

| id | type | bundle cos | atomic cos | delta | atomic rank | criterion | violation | note |
|----|:----:|-----------:|-----------:|------:|:-----------:|-----------|:---------:|------|
...
| p0_07 | A | 0.5743 | 0.6777 | +0.1033 | 2 | Type A: rank==1 & delta>0 | YES |  |
| p0_08 | B | 0.3617 | 0.3327 | -0.0290 | 4 | Type B: rank<=3 attribution check only | YES |  |
...
| b1_20 | B | 0.3837 | 0.3298 | -0.0538 | 3 | Type B: rank<=3 attribution check only |  |  |
...
| b1_27 | B | 0.4151 | 0.3117 | -0.1034 | 3 | Type B: rank<=3 attribution check only |  |  |
...
| b2_34 | A | 0.5758 | 0.5462 | -0.0296 | 2 | Type A: rank==1 & delta>0 | YES |  |
| b2_35 | A | 0.5292 | 0.4340 | -0.0952 | 3 | Type A: rank==1 & delta>0 | YES |  |
| b2_36 | B | 0.4615 | 0.3339 | -0.1276 | 5 | Type B: rank<=3 attribution check only | YES | Type B exception (PI ruling, batch_03; pattern-test datapoint) |
...
| b4_61 | A | 0.6341 | 0.8068 | +0.1728 | 1 | Type A: rank==1 & delta>0 |  |  |
| b4_62 | B | 0.5728 | 0.4286 | -0.1443 | 1 | Type B: rank<=3 attribution check only |  |  |
| b4_63 | A | 0.5241 | 0.9646 | +0.4406 | 1 | Type A: rank==1 & delta>0 |  |  |
| b4_64 | A | 0.3537 | 0.4554 | +0.1017 | 1 | Type A: rank==1 & delta>0 |  |  |
| b4_65 | A | 0.2794 | 0.4522 | +0.1728 | 2 | Type A: rank==1 & delta>0 | YES |  |
| b4_66 | A | 0.4677 | 0.4243 | -0.0435 | 1 | Type A: rank==1 & delta>0 | YES |  |
| b4_67 | A | 0.4349 | 0.8053 | +0.3704 | 1 | Type A: rank==1 & delta>0 |  |  |
| b4_68 | A | 0.4858 | 0.5424 | +0.0566 | 1 | Type A: rank==1 & delta>0 |  |  |
| b4_69 | A | 0.4914 | 0.4791 | -0.0123 | 2 | Type A: rank==1 & delta>0 | YES |  |
| b4_70 | A | 0.3558 | 0.4606 | +0.1048 | 1 | Type A: rank==1 & delta>0 |  |  |
| b4_71 | A | 0.3457 | 0.6429 | +0.2972 | 1 | Type A: rank==1 & delta>0 |  |  |
| b4_72 | A | 0.5996 | 0.7505 | +0.1509 | 1 | Type A: rank==1 & delta>0 |  |  |
| b4_73 | A | 0.3055 | 0.3250 | +0.0195 | 6 | Type A: rank==1 & delta>0 | YES |  |
| b4_74 | B | 0.4810 | 0.7174 | +0.2363 | 1 | Type B: rank<=3 attribution check only |  |  |
| b4_75 | B | 0.6695 | 0.7912 | +0.1217 | 1 | Type B: rank<=3 attribution check only |  |  |

- Type B rank>3 (PI pattern-test): cumulative 2 (this batch new: 0); ids: ['p0_08', 'b2_36']. If these cluster (multiple), the Type B rank<=3 criterion itself is due for re-review.

_Manual-review items (Check 3):_
- 23 secret(s) whose own anchor is not nearest.
- atomic gate(a) violations (offset_type-scoped): p0_07, p0_08, b1_19, b2_34, b2_35, b2_36, b4_65, b4_66, b4_69, b4_73.
...
- **PRIMARY: top-1 secret-secret cosine = 0.6404 -> [ok]** (b1_22 ~ b4_70; thresholds: WARNING>0.70, STOP-AND-REVIEW>0.75).
- (descriptive) same-domain NN: 36/75 (0.480); cross-domain NN share 0.520.
- (descriptive) domains=16, avg members/domain = 4.6875.

**Trend (this batch vs frozen prior batches):**

| metric | this batch | baseline batch_01 (frozen) | batch_02 | batch_03 |
|--------|-----------:|-----------:|-----------:|-----------:|
| top-1 secret-secret cosine (PRIMARY) | 0.6404 | 0.6028 (Δ+0.0376) | 0.6028 (Δ+0.0376) | 0.6220 (Δ+0.0184) |
| cross-domain NN share (descriptive) | 0.520 | 0.667 (Δ-0.147) | 0.622 (Δ-0.102) | 0.583 (Δ-0.063) |
| avg members/domain | 4.6875 | 1.8750 | 2.8125 | 3.7500 |
...
| b4_72 | liquidity_management | b3_56 | portfolio_insurance | 0.4989 |
...
| b4_72 | liquidity_management | b3_56 | portfolio_insurance | 0.4989 | NO |
...
|-----:|---|----------|---|----------|-------:|
| 1 | b1_22 | market_making | b4_70 | market_making | 0.6404 |
| 2 | b2_43 | portfolio_insurance | b3_56 | portfolio_insurance | 0.6220 |
| 3 | p0_15 | credit_screening | b4_68 | credit_screening | 0.6104 |
| 4 | p0_01 | technical_indicator | b1_16 | technical_indicator | 0.6028 |
| 5 | b1_25 | liquidity_management | b2_39 | liquidity_management | 0.5954 |
| 6 | p0_13 | stat_arb | b1_19 | execution_scheduling | 0.5950 |
| 7 | p0_08 | settlement_ops | b2_40 | prime_brokerage_margin | 0.5870 |
| 8 | b1_20 | settlement_ops | b3_59 | settlement_ops | 0.5822 |
| 9 | p0_02 | factor_model | b4_66 | factor_model | 0.5746 |
| 10 | b1_28 | position_sizing | b3_48 | execution_scheduling | 0.5663 |

_Manual-review items (Check 5):_
- PRIMARY top-1 secret-secret cosine 0.6404 -> [ok] (b1_22 ~ b4_70).
- 8 newly-contributing cross-domain NN pair(s) from this batch (descriptive — see table above).
